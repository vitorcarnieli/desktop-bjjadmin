...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(".\\../../icons/lesson.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_menu_lessons.setIcon(icon1)
...
"}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(".\\../../icons/groups-white.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_menu_student.setIcon(icon2)
...
"}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(".\\../../icons/administrative.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_menu_message_forwarding.setIcon(icon3)
...
"}")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(".\\../../icons/record_fill.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_registers.setIcon(icon4)
...
"                            }")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(".\\../../../../../2tec/engagement-telegram/views/icons/plus.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_add_student.setIcon(icon5)
...
"                            }")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(".\\../../../../../2tec/engagement-telegram/views/icons/delete.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_remove_student.setIcon(icon6)
...
"                              ")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(".\\../../icons/refresh_white.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_reload_records.setIcon(icon7)
...
"                            }")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(".\\../../icons/money.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_money_on.setIcon(icon8)
...
"                            }")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(".\\../../icons/money_forgiven.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_money_forgiven.setIcon(icon9)
...
"                            }")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(".\\../../icons/un_money_money.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_money_off.setIcon(icon10)
...
"                            }")
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(".\\../../icons/whatsapp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_whatsapp.setIcon(icon11)
